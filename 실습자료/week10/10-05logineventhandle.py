...
lb = Label(win)
lb.grid(row=2, column=0, columnspan=2) # 두 열을 합해 배치
bt1 = Button(lb, text='OK', command=checkid) # 버튼을 누르면 checkid 함수 호출
bt2 = Button(lb, text='CANCLE')
bt1.grid(row=0, column=0, padx=10) # 외부 여백에 10을 둠
bt2.grid(row=0, column=1, padx=10) # 외부 여백에 10을 둠
